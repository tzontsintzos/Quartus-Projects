...
ARCHITECTURE structure OF ask2 IS
...
\inst18~0\ : maxv_lcell
-- Equation(s):
-- \inst18~0_combout\ = (\x3~combout\ & ((\x4~combout\ & (\x2~combout\ $ (\x1~combout\))) # (!\x4~combout\ & (\x2~combout\ & \x1~combout\)))) # (!\x3~combout\ & (\x4~combout\ & (\x2~combout\ & \x1~combout\)))
